...
const loginUser = (loginData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHalpers_1.jwtHelpers.createToken({ id: isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.id, email: isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.email, role: isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.role }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    // generating refresh token
    const refreshToken = jwtHalpers_1.jwtHelpers.createToken({ email: isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.email, role: isUserExist.role }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    return {
        accessToken,
        refreshToken,
    };
